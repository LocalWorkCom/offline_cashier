...
@Component({
  ...
  templateUrl: './returned-invoice.component.html',
  styleUrl: './returned-invoice.component.css',
  providers: [DatePipe]
})
export class ReturnedInvoiceComponent implements OnInit {printOptions = [
