...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('contact_information_settings', function (Blueprint $table) {
            if (!Schema::hasColumn('contact_information_settings', 'created_by')) {
                $table->unsignedBigInteger('created_by')->nullable();
            }

            if (!Schema::hasColumn('contact_information_settings', 'modified_by')) {
                $table->unsignedBigInteger('modified_by')->nullable()->after('created_by');
            }

            if (!Schema::hasColumn('contact_information_settings', 'deleted_by')) {
