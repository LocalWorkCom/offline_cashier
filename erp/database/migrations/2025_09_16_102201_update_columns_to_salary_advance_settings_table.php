...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('salary_advance_settings', function (Blueprint $table) {
            ...
            if (!Schema::hasColumn('salary_advance_settings', 'created_by')) {
                $table->unsignedBigInteger('created_by')->nullable();
            }

            if (!Schema::hasColumn('salary_advance_settings', 'modified_by')) {
                $table->unsignedBigInteger('modified_by')->nullable()->after('created_by');
            }

            if (!Schema::hasColumn('salary_advance_settings', 'deleted_by')) {
