...
return new class extends Migration
{
    ...
    {
        Schema::table('branch_regions', function (Blueprint $table) {
            if (!Schema::hasColumn('branch_regions', 'created_by')) {
                $table->unsignedBigInteger('created_by')->nullable();
            }

            if (!Schema::hasColumn('branch_regions', 'modified_by')) {
                $table->unsignedBigInteger('modified_by')->nullable()->after('created_by');
            }

            if (!Schema::hasColumn('branch_regions', 'deleted_by')) {
