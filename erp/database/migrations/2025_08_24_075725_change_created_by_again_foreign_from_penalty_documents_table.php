...
return new class extends Migration
{
    ...
    {
        Schema::table('penalty_documents', function (Blueprint $table) {
            if (!Schema::hasColumn('penalty_documents', 'created_by')) {
                $table->unsignedBigInteger('created_by')->nullable();
            }

            if (!Schema::hasColumn('penalty_documents', 'modified_by')) {
                $table->unsignedBigInteger('modified_by')->nullable()->after('created_by');
            }

            if (!Schema::hasColumn('penalty_documents', 'deleted_by')) {
