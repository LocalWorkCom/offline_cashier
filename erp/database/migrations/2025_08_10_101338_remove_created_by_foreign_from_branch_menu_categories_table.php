...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('branch_menu_categories', function (Blueprint $table) {
            ...
            if (Schema::hasColumn('branch_menu_categories', 'created_by')) {
            ...
            if (!Schema::hasColumn('branch_menu_categories', 'modified_by')) {
                $table->integer('modified_by')->nullable()->change();
            }

            if (!Schema::hasColumn('branch_menu_categories', 'deleted_by')) {
                $table->integer('deleted_by')->nullable()->change();
            }

            // Add type columns
            if (!Schema::hasColumn('branch_menu_categories', 'created_by_type')) {
                $table->string('created_by_type')->nullable()->after('created_by');
            }

            if (!Schema::hasColumn('branch_menu_categories', 'modified_by_type')) {
                $table->string('modified_by_type')->nullable()->after('modified_by');
            }

            if (!Schema::hasColumn('branch_menu_categories', 'deleted_by_type')) {
