...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('branch_menu_addons', function (Blueprint $table) {
            ...
            if (Schema::hasColumn('branch_menu_addons', 'created_by')) {
            ...
            if (!Schema::hasColumn('branch_menu_addons', 'modified_by')) {
                $table->integer('modified_by')->nullable()->change();
            }

            if (!Schema::hasColumn('branch_menu_addons', 'deleted_by')) {
                $table->integer('deleted_by')->nullable()->change();
            }

            // Add type columns
            if (!Schema::hasColumn('branch_menu_addons', 'created_by_type')) {
                $table->string('created_by_type')->nullable()->after('created_by');
            }

            if (!Schema::hasColumn('branch_menu_addons', 'modified_by_type')) {
                $table->string('modified_by_type')->nullable()->after('modified_by');
            }

            if (!Schema::hasColumn('branch_menu_addons', 'deleted_by_type')) {
