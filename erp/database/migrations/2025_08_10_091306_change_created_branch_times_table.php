...
return new class extends Migration
{
    ...
    {
        Schema::table('branch_times', function (Blueprint $table) {
            if (!Schema::hasColumn('branch_times', 'created_by')) {
                $table->unsignedBigInteger('created_by')->nullable();
            }

            if (!Schema::hasColumn('branch_times', 'modified_by')) {
                $table->unsignedBigInteger('modified_by')->nullable()->after('created_by');
            }

            if (!Schema::hasColumn('branch_times', 'deleted_by')) {
