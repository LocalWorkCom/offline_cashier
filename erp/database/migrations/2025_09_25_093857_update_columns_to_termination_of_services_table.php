...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('termination_of_services', function (Blueprint $table) {
            ...
            if (!Schema::hasColumn('termination_of_services', 'created_by')) {
                $table->unsignedBigInteger('created_by')->nullable();
            }

            if (!Schema::hasColumn('termination_of_services', 'modified_by')) {
                $table->unsignedBigInteger('modified_by')->nullable()->after('created_by');
            }

            if (!Schema::hasColumn('termination_of_services', 'deleted_by')) {
