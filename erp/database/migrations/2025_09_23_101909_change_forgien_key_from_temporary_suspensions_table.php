   ...
   public function up(): void
    {
        Schema::table('temporary_suspensions', function (Blueprint $table) {
            if (!Schema::hasColumn('temporary_suspensions', 'created_by')) {
                $table->unsignedBigInteger('created_by')->nullable();
            }

            if (!Schema::hasColumn('temporary_suspensions', 'modified_by')) {
                $table->unsignedBigInteger('modified_by')->nullable()->after('created_by');
            }

            if (!Schema::hasColumn('temporary_suspensions', 'deleted_by')) {
