...
return new class extends Migration
{
    ...
    {
        Schema::table('cashier_machines', function (Blueprint $table) {
            if (!Schema::hasColumn('cashier_machines', 'created_by')) {
                $table->unsignedBigInteger('created_by')->nullable();
            }

            if (!Schema::hasColumn('cashier_machines', 'modified_by')) {
                $table->unsignedBigInteger('modified_by')->nullable()->after('created_by');
            }

            if (!Schema::hasColumn('cashier_machines', 'deleted_by')) {
