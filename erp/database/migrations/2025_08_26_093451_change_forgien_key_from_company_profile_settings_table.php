...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('company_profile_settings', function (Blueprint $table) {
            if (!Schema::hasColumn('company_profile_settings', 'created_by')) {
                $table->unsignedBigInteger('created_by')->nullable();
            }

            if (!Schema::hasColumn('company_profile_settings', 'modified_by')) {
                $table->unsignedBigInteger('modified_by')->nullable()->after('created_by');
            }

            if (!Schema::hasColumn('company_profile_settings', 'deleted_by')) {
