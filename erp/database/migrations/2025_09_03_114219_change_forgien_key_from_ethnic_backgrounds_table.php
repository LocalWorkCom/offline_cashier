...
return new class extends Migration
{
    ...
    {
        Schema::table('ethnic_backgrounds', function (Blueprint $table) {
            if (!Schema::hasColumn('ethnic_backgrounds', 'created_by')) {
                $table->unsignedBigInteger('created_by')->nullable();
            }

            if (!Schema::hasColumn('ethnic_backgrounds', 'modified_by')) {
                $table->unsignedBigInteger('modified_by')->nullable()->after('created_by');
            }

            if (!Schema::hasColumn('ethnic_backgrounds', 'deleted_by')) {
