...
return new class extends Migration
{
    ...
    {
        Schema::table('employee_machines', function (Blueprint $table) {
            if (!Schema::hasColumn('employee_machines', 'created_by')) {
                $table->unsignedBigInteger('created_by')->nullable();
            }

            if (!Schema::hasColumn('employee_machines', 'modified_by')) {
                $table->unsignedBigInteger('modified_by')->nullable()->after('created_by');
            }

            if (!Schema::hasColumn('employee_machines', 'deleted_by')) {
