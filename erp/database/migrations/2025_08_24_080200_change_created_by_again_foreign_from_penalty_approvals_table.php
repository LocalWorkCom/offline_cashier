...
return new class extends Migration
{
    ...
    {
        Schema::table('penalty_approvals', function (Blueprint $table) {
            if (!Schema::hasColumn('penalty_approvals', 'created_by')) {
                $table->unsignedBigInteger('created_by')->nullable();
            }

            if (!Schema::hasColumn('penalty_approvals', 'modified_by')) {
                $table->unsignedBigInteger('modified_by')->nullable()->after('created_by');
            }

            if (!Schema::hasColumn('penalty_approvals', 'deleted_by')) {
