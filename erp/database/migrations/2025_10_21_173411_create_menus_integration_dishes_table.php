...
return new class extends Migration
{
    ...
    {
        Schema::create('menus_integration_dishes', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('menus_integration_id')->nullable();
            $table->unsignedBigInteger('branch_menu_id')->nullable();
            $table->decimal('price', 10,2)->nullable()->default(0);
            $table->boolean('is_percentage')->nullable()->default(0);
            $table->decimal('percentage_amount', 10,2)->nullable()->default(0);
            $table->boolean('is_taxed')->nullable()->default(0);
    ...
    {
        Schema::dropIfExists('menus_integration_dishes');
    }
};
