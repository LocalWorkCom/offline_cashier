...
return new class extends Migration
{
 ...
 if (!Schema::hasColumn('addon_categories', 'created_by')) {
                $table->unsignedBigInteger('created_by')->nullable();
            }

            if (!Schema::hasColumn('addon_categories', 'modified_by')) {
                $table->unsignedBigInteger('modified_by')->nullable()->after('created_by');
            }

            if (!Schema::hasColumn('addon_categories', 'deleted_by')) {
    ...
    {
        Schema::table('addons_categories', function (Blueprint $table) {
            //
        });
    }
};
