...
return new class extends Migration {
    public function up()
    {
        Schema::table('dish_ingredient_steps', function (Blueprint $table) {
            $table->json('recipe_steps')->nullable()->change();
            $table->text('recipe_title')->nullable()->change();
    ...
    {
        Schema::table('dish_ingredient_steps', function (Blueprint $table) {
            $table->json('recipe_steps')->nullable(false)->change();
            $table->text('recipe_title')->nullable(false)->change();
