...
return new class extends Migration
{
    ...
    {
        Schema::create('menus_integration_dish_sizes', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('menus_integration_id')->nullable();
            $table->unsignedBigInteger('branch_menu_id')->nullable();
            $table->unsignedBigInteger('branch_menu_size_id')->nullable();
            ...
            $table->foreign('branch_menu_size_id')->references('id')->on('branch_menu_sizes')->onUpdate('cascade');
        });
    }
    ...
    {
        Schema::dropIfExists('menus_integration_dish_sizes');
    }
};
