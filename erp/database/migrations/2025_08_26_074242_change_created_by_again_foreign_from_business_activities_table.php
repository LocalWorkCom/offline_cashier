...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('business_activities', function (Blueprint $table) {
            if (!Schema::hasColumn('business_activities', 'created_by')) {
                $table->unsignedBigInteger('created_by')->nullable();
            }

            if (!Schema::hasColumn('business_activities', 'modified_by')) {
                $table->unsignedBigInteger('modified_by')->nullable()->after('created_by');
            }

            if (!Schema::hasColumn('business_activities', 'deleted_by')) {
