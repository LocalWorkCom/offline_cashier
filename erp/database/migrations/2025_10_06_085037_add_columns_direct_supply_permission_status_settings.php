...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('direct_supply_permission_status_settings', function (Blueprint $table) {
            if (!Schema::hasColumn('direct_supply_permission_status_settings', 'created_by')) {
                $table->unsignedBigInteger('created_by')->nullable();
            }

            if (!Schema::hasColumn('direct_supply_permission_status_settings', 'modified_by')) {
                $table->unsignedBigInteger('modified_by')->nullable()->after('created_by');
            }

            if (!Schema::hasColumn('direct_supply_permission_status_settings', 'deleted_by')) {
