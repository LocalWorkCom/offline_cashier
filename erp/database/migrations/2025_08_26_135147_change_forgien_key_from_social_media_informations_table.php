...
return new class extends Migration
{
    ...
    {
        Schema::table('social_media_informations', function (Blueprint $table) {
            if (!Schema::hasColumn('social_media_informations', 'created_by')) {
                $table->unsignedBigInteger('created_by')->nullable();
            }

            if (!Schema::hasColumn('social_media_informations', 'modified_by')) {
                $table->unsignedBigInteger('modified_by')->nullable()->after('created_by');
            }

            if (!Schema::hasColumn('social_media_informations', 'deleted_by')) {
