...
return new class extends Migration
{
    ...
    {
        Schema::table('cashier_setting_log', function (Blueprint $table) {
            if (!Schema::hasColumn('cashier_setting_log', 'created_by')) {
                $table->unsignedBigInteger('created_by')->nullable();
            }

            if (!Schema::hasColumn('cashier_setting_log', 'modified_by')) {
                $table->unsignedBigInteger('modified_by')->nullable()->after('created_by');
            }

            if (!Schema::hasColumn('cashier_setting_log', 'deleted_by')) {
