                                    ...
                                    <div class="modal-content">
                                        <form id="edit-menu-form" action="" method="POST" class="needs-validation" novalidate>
                                            ...
                                            <div class="modal-body">
                                                <div class="row gy-4">
                                                    <div class="col-xl-12 col-lg-8 col-md-8 col-sm-12" id="price-input-container" style="display: none;">
                                                    ...
                                                    <div class="col-xl-12 col-lg-8 col-md-8 col-sm-12" id="price-input-container-no-size" style="display: none;">
                                                        <label for="branch" class="form-label">@lang('branch_menu.NoSize')</label>
                                                    </div>

                                                    <div class="col-xl-12 col-lg-8 col-md-8 col-sm-12">
                                                        <label for="branch" class="form-label">@lang('branch_menu.MenuIntegrations')</label>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data.menus_integration_dishes && data.menus_integration_dishes.length > 0) {
                        data.menus_integration_dishes.forEach(function(size, index) {
                            if (size.menus_integrations) {
                                integrationsHtml += `
                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                        <span>${size.menus_integrations.name ?? '—'}</span>
                                        <input 
                                            type="number" 
                                            step="0.01"
                                        ...
                                        <input 
                                            type="hidden" 
                                            name="menus_integration_dishes[${index}][id]" 
                                            value="${size.id}">
                                    </li>`;
                            }
                        });
