                ...
                <div class="col-xl-12">
                    <div class="card custom-card">
                        ...
                        justify-content: space-between;">
                            ...
                            @if (auth('admin')->user()->hasPermissionTo('create colors', 'admin'))
                                    ...
                                    @foreach ($Colors as $colors)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @if (auth('admin')->user()->hasPermissionTo('update colors', 'admin'))
                                                    <!-- Edit Button -->
                                                    <button type="button"
                                                ...
                                                @if (auth('admin')->user()->hasPermissionTo('delete colors', 'admin'))
                                                    <!-- Delete Button -->
                                                    <form class="d-inline" id="delete-form-{{ $colors->id }}"
                                                        ...
                                                        @method('DELETE')
                                                        <button type="button"
                                                            onclick="delete_item('{{ $colors->id }}')"
                                                            class="btn btn-danger-light btn-wave">
                                                            @lang('category.delete') <i class="ri-delete-bin-line"></i>
                                                        </button>
                                                    </form>
                                                @endif
                                                <?php /*<form class="d-inline" action="{{ route('color.delete', $colors->id) }}" method="POST" onsubmit="return confirmDelete()">
                                                    @csrf
                                                    @method('DELETE')
