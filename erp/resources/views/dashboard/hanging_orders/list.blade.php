                                    ...
                                    @if ($complaints)
                                        @foreach ($complaints as $complaint)
                                            <tr>
                                                ...
                                                <td>{{ app()->getLocale() == 'en' ? $complaint['branch_en'] : $complaint['branch_ar'] }}
                                                </td>
                                                ...
                                                <td>
                                                    @if (auth('admin')->user()->hasPermissionTo('view hanging-orders', 'admin'))
                                                        <a href="{{ route('hanging-order.show', $complaint['id']) }}"
                                                            class="btn btn-info-light btn-wave">@lang('category.show') <i
                                                                class="ri-eye-line"></i></a>
                                                    @endif
                                                    @if (auth('admin')->user()->hasPermissionTo('update hanging-orders', 'admin'))
                                                        <a href="{{ route('hanging-order.edit', $complaint['id']) }}"
                                                            class="btn btn-orange-light btn-wave">@lang('category.edit') <i
                                                                class="ri-edit-line"></i></a>
                                                    @endif
                                                    @if (auth('admin')->user()->hasPermissionTo('delete hanging-orders', 'admin'))
                                                        <form class="d-inline" id="delete-form-{{ $complaint['id'] }}"
                                                            action="{{ route('hanging-order.delete', $complaint['id']) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="button"
