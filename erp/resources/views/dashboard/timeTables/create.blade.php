...
@section('content')
    <div class="d-sm-flex d-block align-items-center justify-content-between page-header-breadcrumb">
        <h4 class="fw-medium mb-0">@lang('timeTable.addTable')</h4>
        <div class="ms-sm-1 ms-0">
            <nav>
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a href="{{ route('timeTable.index') }}">@lang('timeTable.timeTables')</a></li>
                    <li class="breadcrumb-item active" aria-current="page">@lang('timeTable.addTable')</li>
                </ol>
            </nav>
        </div>
    </div>
                    ...
                    <div class="card custom-card">
                        ...
                        <div class="card-body">
                            ...
                            @if ($errors->any())
                                ...
                                @endforeach
                            @endif
                            <form method="POST" action="{{ route('timeTable.store') }}" class="needs-validation"
                                novalidate>
                                @csrf
                                <div class="row gy-4">
                                    <!-- Arabic Name -->
                                    <div class="col-xl-6 col-lg-8 col-md-8 col-sm-12">
                                        ...
                                        <input type="text" class="form-control" id="name_ar" name="name_ar"
                                            value="{{ old('name_ar') }}" placeholder="@lang('timeTable.arabicName')" required>
                                    ...
                                    <div class="col-xl-6 col-lg-8 col-md-8 col-sm-12">
                                        ...
                                        <input type="text" class="form-control" id="name_en" name="name_en"
                                            value="{{ old('name_en') }}" placeholder="@lang('timeTable.englishName')" required>
                                        <div class="valid-feedback">
                                            @lang('validation.Correct')
                                        </div>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="col-xl-6 col-lg-8 col-md-8 col-sm-12">
                                        ...
                                        <input type="time" class="form-control" id="on_duty_time" name="on_duty_time"
                                            value="{{ old('on_duty_time') }}" required>
                                        <div class="valid-feedback">
                                            @lang('validation.Correct')
                                        </div>
                                        <div class="invalid-feedback">
                                            @lang('validation.EnterOnDutyTime')
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-6 col-lg-8 col-md-8 col-sm-12">
                                        ...
                                        <input type="time" class="form-control" id="off_duty_time" name="off_duty_time"
                                            value="{{ old('off_duty_time') }}" required>
                                        <div class="valid-feedback">
                                            @lang('validation.Correct')
                                        </div>
                                        <div class="invalid-feedback">
                                            @lang('validation.EnterOffDutyTime')
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-6 col-lg-8 col-md-8 col-sm-12">
                                        ...
                                        <input type="time" class="form-control" id="start_sign_in"
                                            name="start_sign_in" value="{{ old('start_sign_in') }}" required>
                                        <div class="valid-feedback">
                                            @lang('validation.Correct')
                                        </div>
                                        <div class="invalid-feedback">
                                            @lang('validation.EnterStartSignInTime')
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-6 col-lg-8 col-md-8 col-sm-12">
                                        ...
                                        <input type="time" class="form-control" id="end_sign_in"
                                            name="end_sign_in" value="{{ old('end_sign_in') }}" required>
                                        <div class="valid-feedback">
                                            @lang('validation.Correct')
                                        </div>
                                        <div class="invalid-feedback">
                                            @lang('validation.EnterEndSignInTime')
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-6 col-lg-8 col-md-8 col-sm-12">
                                        ...
                                        <input type="time" class="form-control" id="start_sign_out"
                                            name="start_sign_out" value="{{ old('start_sign_out') }}" required>
                                        <div class="valid-feedback">
                                            @lang('validation.Correct')
                                        </div>
                                        <div class="invalid-feedback">
                                            @lang('validation.EnterStartSignOutTime')
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-6 col-lg-8 col-md-8 col-sm-12">
                                        ...
                                        <input type="time" class="form-control" id="end_sign_out"
                                            name="end_sign_out" value="{{ old('end_sign_out') }}" required>
                                        <div class="valid-feedback">
                                            @lang('validation.Correct')
                                        </div>
                                        <div class="invalid-feedback">
                                            @lang('validation.EnterEndSignOutTime')
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-6 col-lg-8 col-md-8 col-sm-12">
                                        ...
                                        <input type="number" class="form-control" id="lateness_grace_period"
                                            name="lateness_grace_period" value="{{ old('lateness_grace_period') }}"
                                    ...
                                    <div class="col-xl-6 col-lg-8 col-md-8 col-sm-12">
                                        ...
                                        <select class="form-control" id="start_late_time_option"
                                            ...
                                            <option value="after_duty_time_grace_period"
                                                {{ old('start_late_time_option') == 'after_duty_time_grace_period' ? 'selected' : '' }}>
                                                @lang('timeTable.afterDutyTimeGracePeriod')
                                            </option>
                                            <option value="after_duty_time"
                                                {{ old('start_late_time_option') == 'after_duty_time' ? 'selected' : '' }}>
                                                @lang('timeTable.afterDutyTime')
                                            </option>
                                            <option value="from_duty_time"
                                                {{ old('start_late_time_option') == 'from_duty_time' ? 'selected' : '' }}>
