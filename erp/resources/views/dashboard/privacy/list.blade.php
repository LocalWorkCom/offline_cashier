                ...
                <div class="col-xl-12">
                    <div class="card custom-card">
                        ...
                        justify-content: space-between;">
                            ...
                            @if (auth('admin')->user()->hasPermissionTo('create privacies', 'admin'))
