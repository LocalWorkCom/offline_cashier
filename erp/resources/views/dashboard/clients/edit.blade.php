                                ...
                                <div class="row gy-4">
                                        ...
                                        <select name="country_code" id="country_code" class="select2 form-control" required>
                                            ...
                                            @foreach (GetCountries() as $country)
                                                <option value="{{ $country->phone_code }}"
                                                    {{ $country->phone_code == $client->country_code ? 'selected' : '' }}>
                                                    {{ $country->phone_code }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-xl-6 col-lg-8 col-md-8 col-sm-12">
                                        ...
                                        <input type="date" class="form-control" id="birth_date" name="birth_date"
                                            value="{{ $client->birth_date }}" placeholder="@lang('client.dateOfBirth')">
                                        <div class="valid-feedback">
                                            @lang('validation.Correct')
                                        </div>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="col-xl-6 col-lg-8 col-md-8 col-sm-12">
                                        ...
                                        <input type="text" class="form-control" id="address_phone"
                                            name="address_phone"
                                            value="{{ $client->addresses->first()->address_phone ?? '' }}"
                                            placeholder="@lang('client.addressPhone')">
                                        <div class="valid-feedback">
                                            @lang('validation.Correct')
                                        </div>
                                        <div class="invalid-feedback">
