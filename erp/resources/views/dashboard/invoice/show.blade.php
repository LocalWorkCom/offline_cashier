                        ...
                        <div class="card-body">
                            ...
                            <div class="invoice-details-card">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <label class="form-label">@lang('einvoice.paymentMethod')</label>
                                        <p class="form-text">{{ $paymentmethod }}</p>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($detail->type == 'dish')
                                                            ...
                                                            @endphp
                                                            {{ $orderDetail->dish->{'name_' . app()->getLocale()} ?? 'N/A' }}
                                                        @else
                                                            @php
                                                                ...
                                                                $orderDetailaddon = $invoice->orders->orderDetails->firstWhere(
                                                                    'id',
                                                                    $addon->order_details_id,
                                                                );
                                                            @endphp
                                                            {{ $addon->Addon->addons->{'name_' . app()->getLocale()} . ' - '  ?? 'N/A' }}
                                                            {{ $orderDetailaddon->dish->{'name_' . app()->getLocale()} ?? 'N/A' }}
                                                        @endif
                                                    </td>
                                                    <td>
                                                        @if ($detail->type == 'dish')
                                                            ...
                                                            @endphp
                                                            {{ $orderDetail->dish->dishSizes->first()->{'size_name_' . app()->getLocale()} ?? 'N/A' }}
                                                        @else
                                                            @php
                                                                $addon = $invoice->orders->orderAddons->firstWhere(
                                                                    'id',
