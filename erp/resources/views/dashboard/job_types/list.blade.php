...
@section('content')
    ...
    <div class="d-sm-flex d-block align-items-center justify-content-between page-header-breadcrumb">
        <h4 class="fw-medium mb-0">@lang('job_types.JobTypes')</h4>
                ...
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">
                        <a href="javascript:void(0);"
                            onclick="window.location.href='{{ route('job_types.list') }}'">@lang('job_types.JobTypes')</a>
                    </li>
                </ol>
            </nav>
        </div>
                    ...
                    <div class="card custom-card">
                        ...
                        justify-content: space-between;">
                            ...
                            <button type="button" class="btn btn-primary label-btn" data-bs-toggle="modal"
                                ...
                                @lang('job_types.AddJobType')
                            </button>
                            @endif
                            <!-- Modal for Adding a JobType -->
                            <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                                aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form action="{{ route('job_type.store') }}" method="POST" class="needs-validation"
                                            ...
                                            <div class="modal-header">
                                                <h6 class="modal-title" id="exampleModalLabel1">@lang('job_types.AddJobType')</h6>
                                            ...
                                            <div class="modal-body">
                                                <div class="row gy-4">
                                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                                        <label for="logo-name" class="form-label">@lang('job_types.ArabicName')</label>
                                                        <input type="text" class="form-control"
                                                            placeholder="@lang('job_types.ArabicName')" name="name_ar" required>
                                                    ...
                                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                                        <label for="logo-name" class="form-label">@lang('job_types.EnglishName')</label>
                                                        <input type="text" class="form-control"
                                                            placeholder="@lang('job_types.EnglishName')" name="name_en" required>
                                                        <div class="valid-feedback">
                                                            @lang('validation.Correct')
                                                        </div>
                                                        <div class="invalid-feedback">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form id="edit-logo-form" action="" method="POST"
                                            ...
                                            @endif
                                            <div class="modal-header">
                                                <h6 class="modal-title" id="editModalLabel">@lang('job_types.EditJobType')</h6>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                    aria-label="Close"></button>
                                            </div>
                                            <div class="modal-body">
                                                <div class="row gy-4">
                                                    <div class="col-xl-12">
                                                        <label for="edit-name"
                                                            class="form-label">@lang('job_types.ArabicName')</label>
                                                    ...
                                                    <div class="col-xl-12">
                                                        <label for="edit-expiration-date"
                                                            class="form-label">@lang('job_types.EnglishName')</label>
                            ...
                            <div class="modal fade" id="showModal" tabindex="-1" aria-labelledby="showModalLabel"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h6 class="modal-title" id="showModalLabel">@lang('job_types.ShowJobType')</h6>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                aria-label="Close"></button>
                                        </div>
                                        <div class="modal-body">
                                            <div class="row gy-4">
                                                <div class="col-xl-12">
                                                    <label class="form-label">@lang('job_types.ArabicName')</label>
                                                    <p id="show-name-ar" class="form-control-static"></p>
                                                </div>
                                                <div class="col-xl-12">
                                                    <label class="form-label">@lang('job_types.EnglishName')</label>
                            ...
                            <table id="file-export" class="table table-bordered text-nowrap" style="width:100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">@lang('job_types.ArabicName')</th>
                                        <th scope="col">@lang('job_types.EnglishName')</th>
...
{{--                                            <td>{{ $job_type->id }}</td>--}}
                                            <td>{{ $rowNumber++  }}</td>
                                            <td>{{ $job_type->name_ar }}</td>
                                            <td>{{ $job_type->name_en }}</td>
                                            <td>
                                                ...
                                                <a href="javascript:void(0);"
                                                    ...
                                                    data-id="{{ $job_type->id }}" data-name-ar="{{ $job_type->name_ar }}"
                                                    data-name-en="{{ $job_type->name_en }}" data-image="{{ $job_type->image }}"
                                                ...
                                                <button type="button" class="btn btn-orange-light btn-wave edit-logo-btn"
                                                    data-id="{{ $job_type->id }}" data-name-ar="{{ $job_type->name_ar }}"
                                                    data-name-en="{{ $job_type->name_en }}"
                                                    data-image="{{ asset($job_type->image) }}"
                                                    data-route="{{ route('job_type.update', ':id') }}" data-bs-toggle="modal"
                                                ...
                                                <form class="d-inline" id="delete-form-{{ $job_type->id }}"
                                                    action="{{ route('job_type.delete', $job_type->id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="button" onclick="delete_item('{{ $job_type->id }}')"
