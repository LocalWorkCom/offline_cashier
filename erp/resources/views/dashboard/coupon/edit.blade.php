                                ...
                                <div class="row gy-4">
                                    ...
                                    <div class="col-xl-6">
                                        ...
                                        <input type="text" name="title_ar" id="title_ar" class="form-control"
                                            value="{{ old('title_ar', $coupon->title_ar) }}" placeholder="@lang('coupon.title_ar')" required>
                                    ...
                                    <div class="col-xl-6">
                                        ...
                                        <input type="text" name="title_en" id="title_en" class="form-control"
                                            value="{{ old('title_en', $coupon->title_en) }}" placeholder="@lang('coupon.title_en')" required>
...
@section('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            // $('#branches').select2({
            //     disabled: {{ auth('admin')->user()->hasRole('Branch Manager') ? 'true' : 'false' }}
            // });
            ...
            function loadDishesForCategory(branch_id, category_id) {
                $.ajax({
                    url: `/dashboard/coupon/categories/${category_id}/dishes/${branch_id}`,
                    type: "GET",
                    dataType: "json",
                    success: function(dishes) {
                        branchCategoryDishMap[branch_id].categories[category_id].dishes = dishes;
            ...
            function initializeFormState() {
                ...
                if (selectedType === 'fixed') {
                    ...
                    if (applyType === 'dish') {
                        $('#dish-application-container').show();
                        if ($('#branches').val()) {
                            // Load categories and dishes for initially selected branches
