                    ...
                    <div class="card custom-card">
                        ...
                        justify-content: space-between;">
                            <div class="card-title">
                                @lang('unit.Units')</div>
                                @if (auth('admin')->user()->hasPermissionTo('create units', 'admin'))
                                ...
                                <tbody>
                                    @foreach ($Units as $units)
                                        <tr>
                                            ...
                                            <td>{{ $units->name_en }}</td>
                                            <td>
                                                @if (auth('admin')->user()->hasPermissionTo('show units', 'admin'))
                                                ...
                                                @if (auth('admin')->user()->hasPermissionTo('update units', 'admin'))
                                                ...
                                                @if (auth('admin')->user()->hasPermissionTo('delete units', 'admin'))
