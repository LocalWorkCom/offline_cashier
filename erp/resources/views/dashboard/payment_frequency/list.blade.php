...
@section('content')
    ...
    <div class="d-sm-flex d-block align-items-center justify-content-between page-header-breadcrumb">
        <h4 class="fw-medium mb-0">@lang('payment_frequency.PaymentTypes')</h4>
                ...
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">
                        <a href="javascript:void(0);"
                           onclick="window.location.href='{{ route('payment_frequencies.list') }}'">@lang('payment_frequency.PaymentTypes')</a>
                    </li>
                </ol>
            </nav>
        </div>
                    ...
                    <div class="card custom-card">
                        <div class="card-header" style="display: flex; justify-content: space-between;">
                            <div class="card-title">
                                @lang('payment_frequency.PaymentTypes')
                            </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h6 class="modal-title" id="showModalLabel">@lang('payment_frequency.ShowPaymentType')</h6>
                                        ...
                                        <div class="modal-body">
                                            <div class="row gy-4">
                                                <div class="col-xl-12">
                                                    <label class="form-label">@lang('payment_frequency.ArabicName')</label>
                                                    <p id="show-name-ar" class="form-control-static"></p>
                                                </div>
                                                <div class="col-xl-12">
                                                    <label class="form-label">@lang('payment_frequency.EnglishName')</label>
                        ...
                        <div class="card-body">
                            ...
                            <table id="file-export" class="table table-bordered text-nowrap" style="width:100%">
                                ...
                                <tr>
                                    ...
                                    <th scope="col">@lang('payment_frequency.ArabicName')</th>
                                    <th scope="col">@lang('payment_frequency.EnglishName')</th>
                                ...
                                @foreach ($payment_frequencies as $payment_frequency)
                                    <tr>
                                        <td>{{ $rowNumber++ }}</td>
                                        <td>{{ $payment_frequency->name_ar }}</td>
                                        <td>{{ $payment_frequency->name_en }}</td>
                                        <td>
                                            @if (auth('admin')->user()->hasPermissionTo('view payment_frequencies', 'admin'))
                                                <!-- Show Button -->
                                                <a href="javascript:void(0);"
                                                   class="btn btn-info-light btn-wave show-payment-type-btn"
                                                   data-id="{{ $payment_frequency->id }}"
                                                   data-name-ar="{{ $payment_frequency->name_ar }}"
                                                   data-name-en="{{ $payment_frequency->name_en }}"
