                            ...
                            <table id="file-export" class="table table-bordered text-nowrap" style="width:100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">@lang('report.order_counts')</th>
                                        <th scope="col">@lang('report.total_price')</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach ($clients as $k_client=>$client)
                                        <tr>
                                            <td>{{ $k_client+1 }}</td>
                                            <td>{{ $client->name }}</td>
                                            <td><a href="">{{ $client->orders->count() }}</a></td>
                                            <td>{{ $client->orders->sum('total_price_after_tax') }}</td>
                                        </tr>
                                    @endforeach
