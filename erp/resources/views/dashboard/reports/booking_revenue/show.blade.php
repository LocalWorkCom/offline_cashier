...
@section('content')
    ...
    <div class="d-sm-flex d-block align-items-center justify-content-between page-header-breadcrumb">
        <h4 class="fw-medium mb-0">@lang('order.table_order_details')</h4>
        <div class="ms-sm-1 ms-0">
            <nav>
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a href="{{ route('reports.booking_revenue.list') }}">@lang('order.tables_orders_revenue')</a></li>
                    <li class="breadcrumb-item active" aria-current="page">@lang('order.table_order_details')</li>
                </ol>
            </nav>
        </div>
    </div>
                        ...
                        <div class="col-xl-12">
                            <div class="card custom-card">
                                <div class="card-header">
                                    <div class="card-title">@lang('order.table')</div>
                                </div>
                                <div class="card-body">
                                    <ul class="list-group">
                                        <!-- Table info section -->
                                        <li class="list-group-item">
                                            <strong>@lang('order.table_name')</strong>
                                            <div class="d-flex justify-content-between mt-2">
                                                <span>{{ $order->Table ? (app()->getLocale() === 'ar' ? $order->Table->name_ar : $order->Table->name_en) : __('order.none') }}</span>
                                            </div>
                                        </li>
                                        <li class="list-group-item">
                                            <strong>@lang('order.branch')</strong>
                                            <div class="mt-2">
                                                <span>{{ $order->branch ? (app()->getLocale() === 'ar' ? $order->branch->name_ar : $order->branch->name_en) : __('order.none') }}</span>
                                            </div>
                                        </li>
                                        <li class="list-group-item">
                                            <strong>@lang('order.total_revenue')</strong>
                                            <div class="mt-2">
                                                <span>{{$order->total_price_after_tax . " " . $order->Branch->country->currency_symbol }}</span>
                                            </div>
                                        </li>
                    ...
                    <div class="card custom-card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <span>{{ number_format(($order->tax_value / ($order->total_price_befor_tax == 0 ? 1 : $order->total_price_befor_tax)) * 100, 2) }}%
                                    </p>
                                </span>
                            </div>
                            {{-- <div class="d-flex justify-content-between">
