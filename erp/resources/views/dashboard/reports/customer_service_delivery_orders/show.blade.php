...
@section('content')
    ...
    <div class="d-sm-flex d-block align-items-center justify-content-between page-header-breadcrumb">
        <h4 class="fw-medium mb-0">@lang('order.customer_service_delivery_order_details')</h4>
        <div class="ms-sm-1 ms-0">
            <nav>
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a href="{{ route('reports.customer_service_delivery_orders.list') }}">@lang('order.customer_service_delivery_orders')</a></li>
                    <li class="breadcrumb-item active" aria-current="page">@lang('order.customer_service_delivery_order_details')</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="container-fluid">
            ...
            <div class="row" id="printable-content">
                <div class="col-xl-8">
                    ...
                    <div class="card custom-card">
                        <div class="card-header">
                            <div class="card-title">@lang('order.customer_service_details')</div>
                        </div>
                        <div class="card-body">
                            @if ($order->customerService)
                                <ul class="list-unstyled order-details-list">
                                    <li>
                                        ...
                                        {{ ($order->customerService->first_name. ' ' .$order->customerService->last_name) ?? __('order.unknown') }}
                                    </li>
                                    <li>
                                        <span class="text-muted">@lang('order.email'):</span>
                                        {{ $order->customerService->email ?? __('order.unknown') }}
                                    </li>
                                    <li>
                                        <span class="text-muted">@lang('order.phone'):</span>
                                        {{ $order->customerService->phone_number ?? __('order.unknown') }}
                                    </li>
                                </ul>
                            @else
                    ...
                    <div class="card custom-card">
                        <div class="card-header">
                            <div class="card-title">@lang('order.delivery_details')</div>
                        </div>
                        <div class="card-body">
                            @if ($order->customerService)
                                <ul class="list-unstyled order-details-list">
                                    <li>
                                        <span class="text-muted">@lang('order.name'):</span>
                                        {{ ($order->delivery->first_name. ' ' .$order->delivery->last_name) ?? __('order.unknown') }}
                                    </li>
                                    <li>
                                        <span class="text-muted">@lang('order.email'):</span>
                                        {{ $order->delivery->email ?? __('order.unknown') }}
                                    </li>
                                    <li>
                                        <span class="text-muted">@lang('order.phone'):</span>
                                        {{ $order->delivery->phone_number ?? __('order.unknown') }}
                                    </li>
                                </ul>
                            @else
                                <span class="text-danger">@lang('order.client_deleted')</span>
                    ...
                    <div class="card custom-card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <span>
        @if($order->total_price_befor_tax != 0)
                                        {{ number_format(($order->tax_value / $order->total_price_befor_tax) * 100, 2) }}%</p>
                                    @else
                                        0% </p>
                                    @endif
    </span>
