...
@section('content')
    ...
    <div class="d-sm-flex d-block align-items-center justify-content-between page-header-breadcrumb">
        <h4 class="fw-medium mb-0">@lang('sidebar.cashier_balance_transactions_reports')</h4>
        <div class="ms-sm-1 ms-0">
            <nav>
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a href="{{route('dashboard.home')}}">@lang('sidebar.Main')</a></li>
                    <li class="breadcrumb-item active" aria-current="page">@lang('sidebar.cashier_balance_transactions_reports')</li>
                </ol>
            </nav>
        </div>
    </div>
                ...
                <div class="col-xl-12">
                    <div class="card custom-card">
                        <div class="card-header" style="display: flex; justify-content: space-between;">
                            <div class="card-title">@lang('sidebar.cashier_balance_transactions_reports')</div>
                        </div>
                        <div class="card-body">
                            @if (session('message'))
...
{{--                                        <td>{{ $balance->email }}</td>--}}
                                        ...
                                        <td>
                                            @if (auth('admin')->user()->hasPermissionTo('detail report_cashier_balance_transactions', 'admin'))
                                                <a href="{{ route('reports.cashier_balance_transactions.show', ['id' => $balance->id]) }}"
