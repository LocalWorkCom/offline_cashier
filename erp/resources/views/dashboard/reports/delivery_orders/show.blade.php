        ...
        <div class="container-fluid">
            ...
            <div class="row" id="printable-content">
                <div class="col-xl-8">
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card custom-card">
                                <div class="card-header">
                                    <div class="card-title">@lang('order.delivery_info')</div>
                                </div>
                                <div class="card-body">
                                    @if ($order->delivery)
                                        <ul class="list-unstyled order-details-list">
                                            <li>
                                                ...
                                                {{ $order->delivery->first_name. " " . $order->delivery->last_name ?? __('order.none') }}
                                            </li>
                                            <li>
                                                <span class="text-muted">@lang('order.email'):</span>
                                                {{ $order->delivery->email ?? __('order.none') }}
                                            </li>
                                            <li>
                                                <span class="text-muted">@lang('order.phone'):</span>
                                                {{ $order->delivery->phone_number ?? __('order.none') }}
                                            </li>
                                        </ul>
                                    @else
                                        <span class="text-danger">@lang('order.driver_deleted')</span>
                                    @endif
                                </div>
                ...
                <div class="col-xl-4">
                        ...
                        <div class="card-body">
                            @if ($order->client)
                                <ul class="list-unstyled order-details-list">
                                    <li>
                                        <span class="text-muted">@lang('order.name'):</span>
                                        {{ $order->client->name ?? __('order.unknown') }}
                                    </li>
                                    <li>
                                        <span class="text-muted">@lang('order.email'):</span>
                                        {{ $order->client->email ?? __('order.unknown') }}
                                    </li>
                                    <li>
                                        <span class="text-muted">@lang('order.phone'):</span>
                                        {{ $order->client->phone ?? __('order.unknown') }}
                                    </li>
                                </ul>
                            @else
                    ...
                    <div class="card custom-card">
                        <div class="card-header">
                            <div class="card-title">@lang('order.delivery_complaints')</div>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between">
                                <ul class="list-unstyled order-details-list">
                                    <li>
                                        <span class="text-muted">@lang('order.name'):</span>
                                        {{ $order->deliveryComplaints->employee->first_name. " " . $order->deliveryComplaints->employee->last_name ?? __('order.none') }}
                                    </li>
                                    <li>
                                        <span class="text-muted">@lang('order.delivery_message'):</span>
                                        {{ $order->deliveryComplaints-> message ?? __('order.none') }}
                                    </li>
                                    <li>
                                        <span class="text-muted">@lang('order.latitude'):</span>
                                        {{ $order->deliveryComplaints->latitude ?? __('order.none') }}
                                    </li>
                                    <li>
                                        <span class="text-muted">@lang('order.longitude'):</span>
                                        {{ $order->deliveryComplaints->longitude ?? __('order.none') }}
                                    </li>
                                </ul>
                            </div>
                            @endif
                    ...
                    <div class="card custom-card">
                        <div class="card-header">
                            <div class="card-title">@lang('order.feedback')</div>
                        </div>
                        <div class="card-body">
                            @if($order->feedback)
                            <div class="d-flex justify-content-between">
                                <ul class="list-unstyled order-details-list">
                                    <li>
                                        <span class="text-muted">@lang('order.rate'):</span>
                                        {{ $order->feedback->rate  ." / 5" ?? __('order.none') }}
                                    </li>
                                    <li>
                                        <span class="text-muted">@lang('order.complaint'):</span>
                                        {{ $order->feedback->complain?? __('order.none') }}
                                    </li>
                                    @if($order->feedback->rate <=2)
                                        <li>
                                            <span class="text-muted">@lang('order.comment'):</span>
                                            {{ $order->feedback->comment ?? __('order.none') }}
                                        </li>
                                        <li>
                                            <span class="text-muted">@lang('order.status'):</span>
                                            @if($order->feedback->status == 'solved')
                                                @lang('complaints.Solved')
                                            @elseif($order->feedback->status == 'inprogress')
