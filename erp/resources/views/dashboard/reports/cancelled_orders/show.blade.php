        ...
        <div class="ms-sm-1 ms-0">
            <nav>
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a href="{{ route('reports.cancelled_orders.list') }}">@lang('order.cancelled_orders')</a></li>
                    <li class="breadcrumb-item active" aria-current="page">@lang('order.cancelled_order_details')</li>
                </ol>
            </nav>
        </div>
    </div>
