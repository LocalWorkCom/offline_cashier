        ...
        <div class="ms-sm-1 ms-0">
            <nav>
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">@lang('branch_safe.title')</li>
                </ol>
            </nav>
        </div>
    </div>
                ...
                <div class="col-xl-12">
                    <div class="card custom-card">
                        <div class="card-header" style="display: flex; justify-content: space-between;">
                            <div class="card-title">@lang('branch_safe.title')</div>
                        </div>
                        <div class="card-body">
                            @if (session('message'))
                                ...
                                <table id="branch-safe-table" class="table table-bordered text-nowrap" style="width:100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>@lang('branch_safe.cash_amount')</th>
                                            <th>@lang('branch_safe.visa_amount')</th>
                                            <th>@lang('branch_safe.created_by')</th>
                                    ...
                                    <tbody>
                                        @foreach ($request['query'] as $branchSafe)
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="badge badge-cash">{{ $branchSafe->cash_amount }}</span>
                                                </td>
                                                <td>
                                                    <span class="badge badge-visa">{{ $branchSafe->visa_amount }}</span>
                                                </td>
                                                <td>
                                                    {{ $branchSafe->creator->first_name }}
                                                    {{ $branchSafe->creator->last_name }}
                                                </td>
                                                <td>
                                                    <a href="{{ route('reports.branch_safe.show', $branchSafe->id) }}"
