                                    ...
                                    <div class="mt-3 d-sm-flex flex-wrap">
                                        <a href="javascript:void(0);" class="p-2 rounded-2 d-flex border m-1">
                                            <div class="attachment-icon me-2">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="wd-25" baseProfile="tiny"
                                                    viewBox="0 0 512 512">
                                                    <path fill="#FFF"
                                        ...
                                        <a href="javascript:void(0);" class="p-2 rounded-2 d-flex m-1 border">
                                            <div class="attachment-icon me-2">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="wd-25"
                                                    viewBox="0 0 512 512">
                                                    <path fill="#FFF"
                                                        d="M422.3 477.9c0 7.6-6.2 13.8-13.8 13.8h-305c-7.6 0-13.8-6.2-13.8-13.8V34.1c0-7.6 6.2-13.8 13.8-13.8h230.1V109h88.7v368.9z">
                                                    </path>
                                                    ...
                                                    <path fill="#59E0B9"
                                                        d="M436.6 450.8v19.5l29.3-19.5zM75.4 450.8v19.5l-29.3-19.5z"></path>
                                                    <path fill="#2EBA98" d="M64.1 308.4h383.7v124.5H64.1z"></path>
                                                    <path fill="#16876B"
                                        ...
                                        <div class="align-items-center">
                                            <div class="mt-sm-0 mt-2">
                                                ...
                                                <p class="mb-0 text-muted">Lorem ipsum dolor sit amet consectetur
                                                    adipisicing elit. Repudiandae, repellendus rem rerum excepturi aperiam
                                                    ipsam temporibus cumque,</p>
                                                <div class="text-center demo-gallery">
                                                    <div class="mt-2">
                                                        <div class="d-flex row row-sm gy-4">
                                                            <span class="col-6 col-lg-4">
                                                                <a href="javascript:void(0)">
                                                                    <img class="img-responsive br-5 w-100"
                                                                        src="{{ asset('build/assets/images/media/media-27.jpg') }}"
                                                                        alt="Thumb-1">
                                                                </a>
                                                            </span>
                                                            <span class="col-6 col-lg-4">
                                                                <a href="javascript:void(0)">
                                                                    <img class="img-responsive br-5 w-100"
                                                                        src="{{ asset('build/assets/images/media/media-28.jpg') }}"
                                                                        alt="Thumb-1">
                                                                </a>
                                                            </span>
                                                            <span class="col-6 col-lg-4">
                                                                <a href="javascript:void(0)">
                                                                    <img class="img-responsive br-5 w-100"
                                                                        src="{{ asset('build/assets/images/media/media-30.jpg') }}"
                                                                        alt="Thumb-1">
                                                                </a>
                                                            </span>
                                                        </div>
                                        ...
                                        <div class="align-items-center">
                                            <div class="mt-sm-0 mt-2">
                                                ...
                                                <p class="mb-0 text-muted">Temporary data will be <span
                                                    ...
                                                    once dedicated time complated Lorem ipsum dolor sit amet consectetur
                                                    adipisicing elit</p>
                                            </div>
                                            <div class="d-flex align-items-end">
                                                ...
                                                <span
                                                    class="ms-auto badge bg-light text-muted timeline-badge mt-2  rounded-1">
                                                    08:10 AM
                                                </span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="flex-fill">
                                        <div class="align-items-center">
                                            <div class="mt-sm-0 mt-2">
                                                ...
                                                <p class="mb-0 text-muted">Social network accounts are at risk check your
                                                    <span
                                                        class="badge bg-success-transparent fw-semibold mx-1">login</span>
                                                    details Lorem ipsum dolor sit amet consectetur adipisicing elit
                                                    <a href="javascript:void(0);"
                                                        class="text-primary ms-2 text-decoration-underline">Read more</a>
                                                </p>
                                            </div>
                                            <div class="ms-auto">
                                                <span
                                    ...
                                    <div class="flex-fill">
                                        <div class="align-items-center">
                                            <div class="mt-sm-0 mt-2">
                                                ...
                                                <p class="mb-0 text-muted">Approved date for sanction of loan is verified
                                                    <i
                                    ...
                                    <div class="flex-fill">
                                        <div class="align-items-center">
                                            <div class="mt-sm-0 mt-2">
                                                ...
                                                <p class="mb-0 text-muted">Changed the password of gmail 4 hrs ago. <span
                                                        class="badge bg-secondary">Update</span></p>
                                            </div>
                                            <div class="ms-auto">
                                                <span
                                                    class="float-end badge bg-light text-muted timeline-badge mt-2  rounded-1">
