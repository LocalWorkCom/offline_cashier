...
@section('content')
        ...
        <div class="container pt-sm-5 pt-4">
            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('show.rating') }}"> @lang('term.YourRating') </a></li>
                </ol>
            </nav>
        </div>
    </section>
    ...
    <section class="comments">
        <div class="container mb-3">
            <div class="row">
                <div class="col-md-12">
                    <h4 class="fw-bold">@lang('term.RatesAndComments')</h4>
                    @if (session('success'))
                                ...
                                <div class="col-md-4 offset-md-1 rate-side py-md-3">
                                    <div class="container-faces">
                                        <div class="feedback">
                                            ...
                                            <h4 class="fw-bold pt-md-3">@lang('term.RateYourExperience')</h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-7 py-md-3">
                                    <h4 class="fw-bold">@lang('term.SendYourNotes')</h4>
                                    <h6 class="text-muted">@lang('term.YourNotes')</h6>
                                    <div class="my-3">
                                        <textarea class="form-control" name="note" rows="3" placeholder="@lang('term.WriteYourNote')"></textarea>
                                    </div>
                                    <button type="submit" class="btn w-100">@lang('category.save')</button>
                                </div>
                            </div>
                        </form>
                    </div>
