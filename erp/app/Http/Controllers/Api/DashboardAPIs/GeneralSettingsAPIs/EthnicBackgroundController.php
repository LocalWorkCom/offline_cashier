...
class EthnicBackgroundController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // try {
            $response = $this->EthnicBackgroundService->index($request, false);
    ...
    public function show(Request $request, $id)
    {
        ...
        try {
            $exists = EthnicBackground::where('id', $id)->exists();
            App::setLocale($lang);
            ...
            $BankName = EthnicBackground::findOrFail($id);
    ...
    public function store(Request $request)
    {
        ...
        try {
            $result = $this->EthnicBackgroundService->store($request, false);
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            $result = $this->EthnicBackgroundService->update($request, $id, false);
    ...
    public function delete(Request $request, $id)
    {
        ...
        try {
            ...
            $response = $this->EthnicBackgroundService->delete($request, $id, false);
            return $response;
        } catch (\Exception $e) {
            return RespondWithBadRequestData($lang, 2);
        }
