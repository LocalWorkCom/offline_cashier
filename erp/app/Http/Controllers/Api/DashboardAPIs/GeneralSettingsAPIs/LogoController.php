...
use App\Services\SettingsServices\LogoService;
...
class LogoController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        try {
            ...
            $query = $this->LogoService->index($request);
    ...
    public function store(Request $request)
    {
        ...
        $policy = $this->LogoService->store($request, null);
    ...
    public function show(Request $request, $id)
    {
        ...
        $exists = Logo::where('id', $id)->exists();

        if (!$exists) {
            return respondError(__('branch_menu_category.not_found'), 404);
        }
        try {
            $policy = $this->LogoService->show($id);
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $data = $this->LogoService->update($request, $id);
    ...
    public function destroy(Request $request, $id)
    {
        ...
        try {
            $response = $this->LogoService->destroy($id, $lang);
