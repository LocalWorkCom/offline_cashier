...
class BusinessActivityController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        try {
            $response = $this->businessActivityService->index($request, false);
    ...
    public function show(Request $request, $id)
    {
        ...
        try {
            $exists = BusinessActivity::where('id', $id)->exists();
            App::setLocale($lang);
            ...
            return ResponseWithSuccessData($lang, $businessActivity, 1);
        } catch (\Exception $e) {
            return RespondWithBadRequestData($lang, 2);
        }
    }
    public function store(Request $request)
    {
        ...
        try {
            $result = $this->businessActivityService->store($request, false);
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            $result = $this->businessActivityService->update($request, $id, false);
    ...
    public function delete(Request $request, $id)
    {
        ...
        try {
            ...
            $response = $this->businessActivityService->destroy($request, $id, false);
            return $response;
        } catch (\Exception $e) {
            return RespondWithBadRequestData($lang, 2);
        }
